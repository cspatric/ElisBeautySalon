    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className='w-full flex gap-6'>
                <div className='w-1/3 bg-white h-48 flex-col flex justify-between rounded-xl p-6'>
            ...
            <div className='w-full flex gap-6'>
                <div className='w-2/3 bg-white h-48 flex-col flex justify-between rounded-xl p-6'>
                </div>
                <div className='w-1/3 bg-white h-48 flex-col flex justify-between rounded-xl p-6'>
                </div>
                </div>
