                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center space-x-4">
                                            <img
                                                ...
                                                alt={service.name}
                                                className="h-12 w-12 rounded-full object-cover bg-gray-200 dark:bg-gray-600"
                                            />
                                            <div>
                                                ...
                                                <p className="text-sm text-gray-500 dark:text-gray-400">R$ {Number(service.price).toFixed(2)} • {Math.floor(service.duration / 60)}h {service.duration % 60}min</p>
                                            </div>
                                        </div>
