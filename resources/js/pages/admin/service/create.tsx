  ...
  return (
    <AppLayout breadcrumbs={breadcrumbs}>
      ...
      <div className="mx-auto max-w-7xl space-y-8 px-6 py-8">
        <div>
          <h2 className="text-2xl font-bold text-gray-800 dark:text-white">Cadastrar Serviço</h2>
          <p className="text-sm text-gray-500 dark:text-gray-400">Preencha as informações do novo serviço</p>
        </div>
