                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400">
                            Gerencie todos os profissionais da sua equipe
                        </p>
                    </div>
                    ...
                    <div className="divide-y divide-gray-200 dark:divide-gray-700">
                        {employees.length === 0 ? (
                            <div className="p-6 text-center">
                                ...
                                <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Adicione seu primeiro profissional clicando no botão acima.</p>
                                <div className="mt-6">
                                    <Button
                                        onClick={() => router.visit(route('employee.create'))}
                                ...
                                <div key={employee.id} className="p-6 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center space-x-4">
                                            <img
                                                src={employee.photo || 'https://ui-avatars.com/api/?name=' + encodeURIComponent(employee.name) + '&background=random'}
                                                alt={employee.name}
                                                className="h-12 w-12 rounded-full bg-gray-200 dark:bg-gray-600 object-cover"
                                            />
                                            <div>
